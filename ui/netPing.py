...
class comLoop:
    ...
    def autoChangeSpeed(self): 
        ...
        if self.autoChangeSpeedCounter > 0 and self.autoSpeed: 
            print(self.speed)
...
#        self.t2.start()
    ...
    def on_programInfoAction_triggered(self):
        QMessageBox.information(self, 'О программе', 'Версия 1.3 (03.05.2018)', QMessageBox.Ok | QMessageBox.NoButton | QMessageBox.NoButton, QMessageBox.Ok)
